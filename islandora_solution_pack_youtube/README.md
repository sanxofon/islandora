# Youtube Solution Pack 

## Introduction

Adds a collection for Youtube URL Objects, could include series or video playlists. It could be associated with the [Islandora JWPlaylist Viewer](https://github.com/sanxofon/islandora_jwplaylist).
